...
if __name__ == '__main__':
	...
	img = ndimage.imread('C:/Users/aminv/Documents/hw6_starter_file/X017qGH.jpg', flatten=True)
	...
	for index in range(len(rank_list)):
		...
		"*** YOUR CODE HERE ***"
		img_compressed = U[:, :k].dot(np.diag(S)[:k, :k].dot(V[:k, :]))
		plt.imshow(img_compressed, cmap='Greys_r')
